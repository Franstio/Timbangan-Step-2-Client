...
const Home = () => {
    ...
    return (
        <main>
            <Disclosure as="nav" className="bg-gray-800 bg">
                {({ open }) => (
                    <>
            ...
            <div className='bg-gray-400 p-5'>
                <div class="flex justify-center gap-10">
                    <div className='flex-1 p-4 border rounded flex justify-stretch bg-white'>
                        <div className='flex-1 p-4 border rounded bg-gray-400 text-center text-5xl font-semibold max-w-xl'>10.00
                        </div>
                ...
                <div class="flex justify-center gap-10 mt-10">
                    <div className='flex-1 p-4 border rounded bg-white'>
                        <h1 className='text-center font-semibold'>Sensor Status</h1>
                        <div className='flex justify-between'>
                            <p className=''>Atas</p>
                    ...
                    <div className='flex-1 p-4 border rounded max-w-md bg-white'>
                        <h1 className='text-center font-semibold'>Lock Status</h1>
                    ...
                    <button className='flex-1 p-4 border rounded max-w-xs flex justify-center items-center bg-white'>Lock Bottom
                    </button>
                </div>
